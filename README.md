...
Terraform module which creates and manages [Alibaba Cloud Quotas resources](https://www.alibabacloud.com/help/en/quota-center). This module provides comprehensive quota management capabilities including quota alarms, quota applications, template quotas, template services, and template applications. It helps organizations efficiently monitor and manage their cloud resource quotas through automated processes.
